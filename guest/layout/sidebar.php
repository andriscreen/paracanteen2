...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Components -->
            <li class="menu-header small text-uppercase"><span class="menu-header-text">Food Orders</span></li>
            <!-- Cards -->
            <li class="menu-item">
              <a href="order-makan.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Basic">Order Makan</div>
              </a>
            </li>
            <li class="menu-item">
            ...
            <li class="menu-item">
              ...
              >
                <i class="menu-icon bi bi-menu-button"></i>
                <div data-i18n="Support">Menu</div>
              </a>
            </li>
            <li class="menu-item">
              <a
