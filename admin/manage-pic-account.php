...
>
  <head>
    ...
    <title>Manage PIC Account | ParaCanteen</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Manage PIC Account</h4>
              ...
              <div class="col-xl">
                <div class="card mb-4">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Add New PIC Account</h5>
                  </div>
                  <div class="card-body">
                    <form action="execution/pic_kantin_action.php" method="POST">
                      <input type="hidden" name="action" value="add">

                      <div class="mb-3">
                        <label class="form-label">Full Name</label>
                        <input type="text" name="nama" class="form-control" placeholder="PIC Kantin" required>
                      </div>
              ...
              <div class="col-xl">
                <div class="card mb-4">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Delete PIC Account</h5>
                  </div>
                  <div class="card-body">
                    <form action="execution/pic_kantin_action.php" method="POST">
                      ...
                      <div class="mb-3">
                        ...
                        <select name="id" class="form-select" required>
                          ...
                          <?php
                            ...
                            $result = mysqli_query($conn, "SELECT id, nama, gmail FROM pic_kantin ORDER BY nama ASC");
