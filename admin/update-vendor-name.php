...
>
  <head>
    ...
    <title>Update Vendor Name | ParaCanteen</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Update Vendor Name</h4>
              ...
              <div class="col-xl">
                <div class="card mb-4">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Add New Vendor Name</h5>
                  </div>
                  <div class="card-body">
                    <form action="execution/vendor_name_action.php" method="POST">
              ...
              <div class="col-xl">
                <div class="card mb-4">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Delete Vendor Name</h5>
                  </div>
                  <div class="card-body">
                    <form action="execution/vendor_name_action.php" method="POST">
                      ...
                      <div class="mb-3">
                        ...
                        <select name="id" class="form-select" required>
                          ...
                          <?php
                            // tampilkan dropdown vendor dari database
                            $result = mysqli_query($conn, "SELECT id, name FROM nama_vendor WHERE is_active = 1 ORDER BY name ASC");
